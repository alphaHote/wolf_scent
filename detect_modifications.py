            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    ####################################>>>>>>>>>> START of modified code <<<<<<<<<<<########################## 
                        ...
                        pp=path.split("\\")[-1]
                        pp=pp.split(".")[0]+".txt"
                        print(pp,",", str(x1/im0.shape[1])+" "+str(y1/im0.shape[0])+" "+str( x2/im0.shape[1])+" "+str(y2/im0.shape[0]))
                        housni.ecrire_txt("housni\\"+pp,str(x1/im0.shape[1])+" "+str(y1/im0.shape[0])+" "+str( x2/im0.shape[1])+" "+str(y2/im0.shape[0])+"\n")
                        # original_img = im0
